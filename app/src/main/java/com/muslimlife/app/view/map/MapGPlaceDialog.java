...
public class MapGPlaceDialog  extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (placesRes.schedule == null || placesRes.schedule.length < 1) {
            ...
            for(String time : placesRes.schedule)
                sb.append(time).append("\n");

            binding.workTimesText.setText(sb.toString());
        }
        ...
        if (placesRes.images == null || placesRes.images.length < 1) {
    ...
    public MapGPlaceDialog(PlacesRes placesRes, LatLng placeLocation){
