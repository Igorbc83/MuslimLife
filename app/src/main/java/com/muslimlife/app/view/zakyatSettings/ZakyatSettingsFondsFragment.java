...
import com.muslimlife.app.databinding.FragmentFondsBinding;
import com.muslimlife.app.view.MainActivity;
import com.muslimlife.app.view.base.BaseFragment;

public class ZakyatSettingsFondsFragment extends BaseFragment {

    private FragmentFondsBinding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding =  FragmentFondsBinding.inflate(inflater, container, false);
